...
const LBWS_IMAGE = 'lunchbadger/workspace';//'410240865662.dkr.ecr.us-west-2.amazonaws.com/lunchbadger-workspace';
const LBWS_VERSION = process.env.LBWS_VERSION || '0.0.8-beta';
