...
class Deployer {
  ...
  ensureSecret (locator, rev, req) {
    return this._ensureObject('Secret', locator, {}, req);
  }
  ...
  async upsertDeployment (locator, deploymentConfig, rev) {
    ...
    const deploymentReq = deploymentJson(locator, containers, volumes, rev);
...
function deploymentJson (locator, containers, volumes, rev) {
