...
module.exports = class ProjectConfig {
  constructor (producer, env, projectJson) {
    ...
    this.disabled = projectJson.disabled;
  }
  ...
  _loadEntities (projectJson) {
    ...
    load(this.portals, projectJson.portals, 'portal', portal => {
      load(this.apis, portal.apis, 'api', api => {
        load(this.apiEndpoints, api.apiEndpoints, 'apiEndpoint', null, {portal, api});
      }, {portal});
    });
